...
-- ------------------------------------------------------------
-- Creates many-to-many relationships from product to material
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Creates many-to-many relationships from plant to inventory
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Creates many-to-many relationships from material to product
-- ------------------------------------------------------------
